...
<input id="wb-srch-q" list="wb-srch-q-ac" class="wb-srch-q form-control" name="q" type="search" value="" size="27" maxlength="150" placeholder="<%=Localization.TemplateStrings.tmpl_search_site %> Canada.ca">
